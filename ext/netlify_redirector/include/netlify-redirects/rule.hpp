...
enum class ConditionResult { conditionMiss, conditionMatch, condition404 };
enum class ConditionType { conditionLanguage, conditionCountry, conditionRole, conditionUnknown };
